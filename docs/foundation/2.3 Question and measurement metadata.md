...
<img src="../img/US_W8-youth-questionnaire_page5.png" alt="Alt Text" width="425" height="900"> 
...
Sometimes a question is accompanied by a further instruction (e.g. 'please tick one option only'). Note the example questionnaire page does not include any statements.
...
|---------------|---------------|-----------------------|----------------------------|----------------------------|
| Q_5           | 5             | How many hours do you spend watching television programmes or films on a normal school day? Please remember to include time spent watching programmes and films on a computer or mobile device. |-  |Code list  |
| Q_6           | 6            | Do you have your own personal mobile phone? |-  |Code list  |
| Q_7           | 7            | Is your mobile a smartphone? A smartphone is a mobile phone that can download apps, send emails and surf the internet. |-  |Code list  |
...
!!! question ""
    ...
    **Which of the following is an example of question or measurement metadata?**
    ...
    ??? success "Reveal answer"
       ...
       The definition of “household income” used in a study. Definitions of variables (e.g. what is included in “income”) are key parts of measurement metadata.
...
- <sup>[1]</sup> Understanding Society. Wave 9 Youth Questionnaire GB. Institute for Social and Economic Research, University of Essex. [Mainstage Questionnaires](https://www.understandingsociety.ac.uk/documentation/mainstage/questionnaires/)
