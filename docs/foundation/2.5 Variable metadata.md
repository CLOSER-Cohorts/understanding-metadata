...
For the example dataset... The unit of measurement for the variable **height in this example is centimeters**. However, unit of measurement will not be applicable to some variables such as first name or marital status. In these cases, you can put N/A.
...
An example of a controlled vocabulary for flags is the [SeaDataNet measurand qualifier flags](https://vocab.nerc.ac.uk/collection/L20/current/) 
...
- <sup>[1]</sup> National Oceanography Centre. (n.d.). *SeaDataNet Measurand Qualifier Flags (L20)*. NERC Vocabulary Server. Available at: https://vocab.nerc.ac.uk/collection/L20/current/
