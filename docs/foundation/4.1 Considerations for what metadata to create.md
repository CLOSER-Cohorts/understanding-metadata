...
If your data has a more limited scope, is exploratory, or is unlikely to be reused outside your own project, extensive metadata may not be needed. In this case, it may be more appropriate to focus on documenting the essential information needed to understand and manage the data. 
...
For more information, see [Unit Metadata standards](https://closer-cohorts.github.io/understanding-metadata-foundation/introduction/2.5%20Metadata%20standards/) of the Introduction to Metadata training course. 
