...
??? question "You’re a researcher about to conduct a study — why might you want to create metadata?"
    ...
    **Metadata may also be required by:**
    ...
    For more information, see [Introduction to Metadata](<https://closer-cohorts.github.io/understanding-metadata/introduction/2.1%20Introduction%20to%20metadata/>) in the Introduction course.
