...
There's no singular software application or tool you should use to create and manage metadata. You can use any software that generates and supports machine readable formats. You may then export your metadata into text based formats such as PDF in order to create further documentation, but the original file must be **machine readable** (for example, XML, JSON, RDF, CSV).
...
Depending on how you create your metadata, it can be stored in different locations. These includes ...
