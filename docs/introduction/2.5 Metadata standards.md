...
!!! example ""
    ...
    **Intended learning outcomes**
    ...
    By the end of the , you'll be able to...
...
!!! info "**Why is it important to take time in finding the best metadata standard for your research?**" 
    ...
    <p align="center">
    <a href="../img/14-15 standards.png" target="_blank">
    <img src="../img/14-15 standards.png" alt="Three-panel black-and-white comic illustrating the proliferation of standards. The first panel states that there are 14 competing standards. In the second panel, two stick figures propose creating a new universal standard to cover all use cases. The third panel, labelled ‘Soon’, states that there are now 15 competing standards." width="425" height="900"> <sup>[7]</sup>
    </a>
    </p>
...
!!! question ""
    ...
    **Which of the following is an example of a metadata standard?**
    ...
    ??? success "Reveal answer"
        ...
        **Dublin Core.** Dublin Core is a widely used metadata standard that provides a simple and consistent set of elements (such as title, creator, subject, and date) for describing resources
...
- [2]: CDSP and CLOSER (2025) 'DDI Metadata Made Simple: Your Top Questions Answered' _FAIRwDDI_ (to be released)
- [3]: CODATA (2025) RDM Terminology Bank: [Metadata Standard](https://terms.codata.org/rdmt/metadata-standard)
...
- [6]: Walsh, S., Kaye, N. & O’Neill, D. (2021). [_Research Case Studies: Childhood environment and adult mental well-being._](https://learning.closer.ac.uk/researchcasestudies/childhood-environment-and-adult-mental-well-being/) CLOSER Learning Hub, London, UK: CLOSER. 
- [7]: [XKCD 927: Standards cartoon](https://xkcd.com/927/)
