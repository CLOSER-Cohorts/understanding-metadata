...
Welcome to the **Introduction to Metadata** training course. The course aims to introduce metadata and its role in helping people understand, discover and use research data.
...
- [1] CODATA (2025) ['Research Data Management Terminology' _RDM Terminology Working Group_](https://codata.org/initiatives/data-science-and-stewardship/rdm-terminology-wg/)
- [2] CODATA (2025) ['CODATA Research Data Management Terminology'](https://vocabs.ardc.edu.au/viewById/685)
