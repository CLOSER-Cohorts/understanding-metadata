...
- [1] Met Office (2026) _Met Office Weather App_ [Mobile app]. Available at: App Store or Google Play Store https://www.metoffice.gov.uk/
- [2] [University of Cambridge (2025) What is research data?](www.data.cam.ac.uk/about/what)
- [3] [Wikipedia (2025) Data](www.en.wikipedia.org/wiki/Data)
- [4] [IBM (2025) What is Data?](https://www.ibm.com/think/topics/data)
- [5] [CODATA (2025) RDM Terminology: Data](https://terms.codata.org/rdmt/data)
- [6] [CODATA (2025) RDM Terminology: Research data](https://terms.codata.org/rdmt/research-data)
