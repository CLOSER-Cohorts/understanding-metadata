...
!!! question "What data is available in the weather app screenshot below<sup>[1]</sup>?"
    ...
    <p align="center">
      <a href="../img/met_office_image.png" target="_blank   src="../img/met_office_image.png"
          alt="Weather app screenshot showing conditions in London. The display shows a temperature of 9°C, light showers, a 70% chance of rain, daily forecasts for several days, and hourly forecasts from 15:00 to 19:00."
          width="215"
          height="500">
      </a>
    </p
