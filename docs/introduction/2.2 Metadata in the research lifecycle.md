...
!!! question "The research lifecycle is often conceived as a circle. Why do you think that is?" 
    ...
    <p align="center">
    <a href="../img/data-lifecycle.png" target="_blank">
    <img src="../img/data-lifecycle.png" alt="An image of the research lifecycle. A circular workflow diagram made up of six dark blue circles connected by arrows. The circles are arranged in a clockwise cycle and labelled ‘DESIGN’, ‘DATA COLLECTION’, ‘DATA MANAGEMENT’, ‘ARCHIVE & DISSEMINATE’, ‘ANALYSIS’, and ‘PUBLICATION’. Dark blue arrows between the circles indicate the flow from one stage to the next, forming a continuous cycle." width="370" height="320">
    </a>
    </p> 
...
<p align="center">
   <a href="../img/Data_lifecycle_MD_circles.png" target="_blank">
<img src="../img/Data_lifecycle_MD_circles.png" alt="An image showing six large purple circles arranged in a ring and labelled ‘Design’, ‘Data Collection’, ‘Data management’, ‘Archive and Disseminate’, ‘Analysis’, and ‘Publication’. In the centre, the word ‘Metadata’ appears in green text and is surrounded by six smaller green circles connected in a circular arrangement with the circles expanding in size at each stage." width="360" height="380">
   </a>
</p>
...
- [1] CODATA (2025) RDM Terminology Bank: [Research data lifecycle](https://terms.codata.org/rdmt/research-data-lifecycle)
- [2] United Nations Economic Commission for Europe (2025) _'Generic Statistical Business Process Model (GSBPM)'_ Switzerland: UNECE
- [3] UK Data Service (2019) _Research Data Lifecycle_ [Online Video] www.youtu.be/-wjFMMQD3UA
- [4] IBM (2025) [What is data provenance?'](www.ibm.com/think/topics/data-provenance)
- [5] CODATA (2025) RDM Terminology Bank: [Provenance](https://terms.codata.org/rdmt/provenance)
...
- [8] CLOSER (2025) '[(Derived) No. of fostered children left the hh since last sweep](https://discovery.closer.ac.uk/item/uk.cls.ncds/372a1d9f-34ef-4b3e-939f-a2e9c1a7c288) in Age 50 Survey, National Child Development Study' (2008) CLOSER Discovery
- [9] CLOSER (2025)'[(Derived) BMI at Interview (age 44)](https://discovery.closer.ac.uk/item/uk.cls.ncds/b5919e90-46db-4a2a-81b9-58ecdcb889e8) in Age 44 Biomedical Survey (2002), National Child Development Study' CLOSER Discovery
