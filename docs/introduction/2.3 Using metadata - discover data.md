...
!!! abstract ""
    ...
    === "Search"
        ...
        <p align="center">
        <a href="../img/Water quality - search.png" target="_blank">
        <img src="../img/Water quality - search.png" alt="Screenshot of UKDS search results page showing records for ‘water quality’, with search filters in a left-hand panel and a list of matching studies in the main results area." width="400" height="600"> 
        </a>
        </p>
    ...
    === "Filter"
        ...
        <p align="center">
        <a href="../img/Water quality%-%filters.png" target="_blank">
        <img src="../img/Water quality - filters.png" alt="Screenshot of UKDS search results page with the filter panel containing fields labelled ‘Date from: 2000’, ‘Date to: 2025’, ‘Topic: Natural environment’, ‘Data Type:’, ‘Access: Open’, and ‘Country: United Kingdom’, with a ‘Refine date’ button and a ‘Reset filters’ link. " width="310" height="500"> 
        </a>
        </p>
...
<p align="center">
<a href="../img/Water quality%-%profile page.png" target="_blank">
<img src="../img/Water quality - profile page.png" alt="Screenshot of a study record in UKDS. The page displays the study title ‘Using Participatory Approaches To Instigate Improvements in Water Quality, 2021-2022’, summary details, and expandable sections for topics, keywords, methodology, citation and edit history." width="360" height="320"> 
</a>
<sup>[3]</sup> 
</p>
...
- You review metadata for an individual variable, such as the data type and linked questions, on UK Data Service Variable and Question Bank. For example, the variable ['Past health problems - 5'](https://datacatalogue.ukdataservice.ac.uk/variables/variable/8b973952-fb8a-4344-959d-a673fe76f540) from the Quarterly Labour Force Survey (July - September 2024 study).<sup>[4]</sup>
...
<p align="center">
   <a href="../img/UKDS-QuVaBank.png" target="_blank">
<img src="../img/UKDS-QuVaBank.png" alt="Screenshot of the UKDS ‘Variable and question bank’ search interface. A filter panel on the left contains expandable sections labelled ‘Data Catalogue’, ‘Variable and question bank’, ‘QualiBank’, ‘Series’, ‘Survey’, ‘Country’, ‘Date’, ‘Data collector’, ‘Question: Harmonised set’, and ‘Question: Intent’. On the right, search results are displayed. " width="360" height="320"> 
   </a>
</p>
...
<p align="center">
   <a href="../img/CLOSER-QuVaFilter.png" target="_blank">
<img src="../img/CLOSER-QuVaFilter.png" alt="Screenshot of CLOSER Discovery search results page. A filter panel across the top contains dropdown menus labelled ‘Item Type’, ‘Study’, ‘Sweep’, ‘Life Stage’, and ‘Topic’, followed by a green ‘Filter’ button and a ‘Reset’ link. Below, search results are listed with labels such as ‘Study’, ‘Name’, and ‘Label’." width="360" height="320"> 
   </a>
</p>
...
<p align="center">
<a href="../img/DISH-Data%Dictionary-Codebook.png" target="_blank">
<img src="../img/DISH-Data Dictionary-Codebook.png" alt="Screenshot of the documentation section of a UKDS study record titled ‘Dietary Intake in Scotland’s Children (DISH), 2024’. The page lists downloadable documents, including datasets, questionnaires, participant information sheets and archiving information. The Documentation tab selected and a list of downloadable files are highlighted with red boxes. Files include datasets, questionnaires, participant information and archive documentation." width="360" height="320"> 
</a>a>
</p>
...
=== "**Codebooks**"
    ...
    <p align="center">
      <a href="../img/DISH-Codebook.png" target="_blank">
    <img src="../img/DISH-Codebook.png" alt="Screenshot of the codebook from the 2024 research project ‘Dietary Intake in Scotland's Children (DISH). It shows a spreadsheet with column headings; ‘Variable’, ‘Type’, ‘Units’, and ‘Description’. The spreadsheet contains rows of variable names with corresponding data types, units, and descriptions. Examples visible include variables relating to sex/gender and age, with descriptions such as ‘Sex/gender of participant’ and ‘Participant age in years’. The spreadsheet includes the worksheet tabs; ‘food_svy’, ‘survey’, ‘intake4’, ‘intake2’, ‘meal’, ‘mealall_participant’, ‘DNF food categories’, ‘DNF dictionary foods’, and ‘NDNS uk food groups’. " width="360" height="320"> 
     </a>
    </p>
...
=== "**Data dictionaries**"
    ...
    <p align="center">
     <a href="../img/DISH-Data-dictionary.png" target="_blank">
    <img src="../img/DISH-Data-dictionary.png" alt="Screenshot of the data dictionary from the 2024 research project ‘Dietary Intake in Scotland's Children (DISH). There are section headings ‘File-level information’ and ‘Variable-level information’. Information includes the file name, number of variables and cases, variable names, labels, and data types. Formatting: headings are shown in bold, and variable names and labels are displayed as blue hyperlinks." width="360" height="320"> 
    </a>
    </p>
...
- [2] CODATA (2025) Research Data Management Terminology: [data catalogue](https://terms.codata.org/rdmt/data-catalogue)
...
- [4] UK Data Service (2025) [Variable: Past health problems - 5 in 'Quarterly Labour Force Survey, July - September, 2024' _UK Data Service Catalogue_](https://discover.ukdataservice.ac.uk//variables/variable/?id=9323_V230)
- [5] CLOSER (2025) [Variable: (A1) Did CM receive housing benefit whilst at address in Age 42, Sweep 6, 1999-2000 in NCDS6 CAI Questionnaire (2000) Dataset _CLOSER Discovery_](https://discovery.closer.ac.uk/item/uk.cls.ncds/c440796b-67e0-4d0c-b7da-6e4e28d0bfe2)
- [6] CLOSER (2025) [Variable: How interested are you in politics? in 'Wave 7 Youth Self-Completion Questionnaire'](https://discovery.closer.ac.uk/item/uk.iser.ukhls/2f1e27ba-e2e9-4bfe-a814-fa54809a77c9) _CLOSER Discovery_
...
- [9] CODATA (2025) Research Data Management Terminology: Data dictionary https://terms.codata.org/rdmt/data-dictionary
